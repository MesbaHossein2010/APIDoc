    ...
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('admin.docs.update', $doc->id) }}">
            ...
            <div class="form-row">
                ...
                <input name="title" value="{{ $doc->title }}" type="text" id="title" class="form-input" placeholder="e.g. API Reference">
                @error('title')
            ...
            <div class="form-row">
                ...
                <input name="slug" value="{{ $doc->slug }}" type="text" id="slug" class="form-input" placeholder="e.g. api-reference">
                @error('slug')
                <p class="form-error">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="form-row">
                ...
                <select name="section_id" id="section_id" class="form-input">
                    ...
                    @foreach ($sections as $section)
                        <option value="{{ $section->id }}" {{ $doc->section->id == $section->id ? 'selected' : '' }}>
                            {{ $section->title }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-row">
                ...
                <textarea name="content" id="content" class="form-input form-textarea" placeholder="Enter section content">{{ old('content', $doc->content) }}</textarea>
                @error('content')
                <p class="form-error">{{ $message }}</p>
                @enderror
            </div>
