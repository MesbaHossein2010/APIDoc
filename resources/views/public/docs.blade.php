...
<style>
    ...
    .sidebar-header input, .cancel-search-btn {
        width: 100%;
        padding: 6px 8px;
        margin-top: 5px;
        border-radius: 4px;
    ...
    body.dark .sidebar-header input, .dark .sidebar-header .cancel-search-btn {
        background-color: #2a2a2a;
        color: #e0e0e0;
        border: 1px solid #444
    }

    body.dark .sidebar-header input::placeholder {
        color: #888
    }
    ...
    body.light .sidebar-header input, .light .sidebar-header .cancel-search-btn {
        background-color: #f5f5f5;
        color: #111;
        border: 1px solid #dcdcdc
    }

    body.light .sidebar-header input::placeholder {
        color: #888
    }

    body.light .docs-content {
        background: #f7f7f8;
        color: #111
    }

    body.light h1, body.light h2, body.light h3, body.light p {
        color: #111
    }
    ...
    body.dark .docs-content pre {
        background-color: #1e1e1e;
        color: #e0e0e0
    }

    body.light .docs-content pre {
    ...
    body.dark .docs-content code {
        background-color: #2a2a2a;
        color: #e0e0e0
    }

    body.light .docs-content code {
        background-color: #dcdcdc;
        color: #111
    }

    body.dark .docs-content b, body.dark .docs-content strong, body.dark .docs-content i, body.dark .docs-content em, body.dark .docs-content u, body.dark .docs-content mark {
        color: inherit
    }

    body.light .docs-content b, body.light .docs-content strong {
        color: #222;
        font-weight: bolder
    }

    body.light .docs-content i, body.light .docs-content em {
        color: #333;
        font-style: italic
    }

    body.light .docs-content u {
        color: #222;
        text-decoration: underline
    }

    body.light .docs-content mark {
