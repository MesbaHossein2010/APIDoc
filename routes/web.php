...
Route::prefix('site-admin')->group(function () {
    ...
    Route::middleware(['CheckAuth'])->group(function () {
        ...
        // Routes with {id}
        Route::get('docs/{id}/edit', [DocController::class, 'edit'])
            ->where('id', '[0-9]+')->name('admin.docs.edit');
        Route::post('docs/{id}/update', [DocController::class, 'update'])
            ->where('id', '[0-9]+')->name('admin.docs.update');
        Route::get('docs/delete/{id}', [DocController::class, 'destroy'])
            ->where('id', '[0-9]+')->name('admin.docs.delete');
        Route::get('docs/{id}', [DocController::class, 'show'])
            ->where('id', '[0-9]+')->name('admin.docs.show');
        ...
        Route::get('sections/{id}/edit', [SectionController::class, 'edit'])
            ->where('id', '[0-9]+')->name('admin.sections.edit');
        Route::post('sections/{id}/update', [SectionController::class, 'update'])
            ->where('id', '[0-9]+')->name('admin.sections.update');
        Route::get('sections/delete/{id}', [SectionController::class, 'destroy'])
            ->where('id', '[0-9]+')->name('admin.sections.delete');
        Route::get('sections/{id}', [SectionController::class, 'show'])
            ->where('id', '[0-9]+')->name('admin.sections.show');
    });
});
